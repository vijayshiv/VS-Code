/*
 floor = largest element in array less or equal to target
 arr = [12, 34, 35, 89, 90, 91] , target = 24
 ceiling(arr, target) = 34

 We need to return the largest lesser element if we cannot find the element in the array.
 */
...
public class FloorOfNumber{
    public static void main(String[] args) {
        ...
        System.out.println(arr[ans] + " in the number less than or equal to target number.");
